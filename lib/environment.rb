...
when :personal
    @personal_data = {
        surname: argument[:surname], age: argument[:age], country: argument[:country],
        language: argument[:language], marital_status: argument[:marital_status], children: argument[:children]
    }

when :professional
    @professional_data = {
        position: argument[:position], occupation: argument[:occupation], skills: argument[:skills], observations: argument[:observations]
    }
